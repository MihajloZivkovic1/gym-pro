            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Upravljajte komunikacijom sa članovima
                </p>
              </div>
            </div>
            <button
              onClick={() => setIsCreating(true)}
              className="bg-emerald-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2 font-medium text-sm sm:text-base w-full sm:w-auto"
            >
              <Send className="w-4 h-4" />
              <span>Novo obaveštenje</span>
            </button>
          </div>
